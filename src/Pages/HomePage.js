...
import { searchAddress, randomAddress } from "../api";
import axios from "axios";
import Loader from "../Components/Loader";

const headerTitle = "Super extra katalog filmowy";
...
const HomePage = () => {
  ...
  useEffect(() => {
    // jeśli searchWord istnieje to korzystamy z adres searchAddress
    // a jeżeli nie to z adresu randomAddress
    setIsLoading(true);
  ...
  // funkcja filtrująca filmy według słowa użytkownika
  // jeśli searchWord to przekazujemy do Catalog wyfiltrowaną tablice filmów,
  // jaęzkli będzie nullem to wówczas przekazujemy allMovies
              ...
              <>
                {movies.length > 0 ? (
                  ...
                  <div className="notfound">
                    Brak filmów o podanych kryteriach
                  </div>
                )}
              </>
            ) : (
